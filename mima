...
▐▀▄▄▄▄▀ ▐      ▄▀       █   ▄▀   █▀▀▀    █▀▀▀    #
▐             █         ▐   ▐    ▐       ▐       #
MADY BY TOMMY ▐   "Abdulrahman Tohamy"  V.2.1    #
##################################################
""", "yellow")
print(tm)
gt = colored(">>", 'blue')
...
if not randompass != 'tommy':
    done = colored('\033[1m' + "\rDONE ! "+ '\033[1m'+randompass , 'green')

    print(done) == True
    animationdone = ('\033[1m' + "[■□□□□□□□□□]", "[■■□□□□□□□□]", "[■■■□□□□□□□]", "[■■■■□□□□□□]", "[■■■■■□□□□□]",
                 "[■■■■■■□□□□]", "[■■■■■■■□□□]", "[■■■■■■■■□□]", "[■■■■■■■■■□]", "[■■■■■■■■■■]")
    time.sleep(1)
    hi = colored(('\033[1m'+"Hi " + randompass+ " Loading Tool!"), 'green')
    print(hi)
...
#      websites links scrap api python
        ...
        if (re.search(regex, new_emails)):
           ...
           print(v)
            ...
            if __name__ == '__main__':
                # Enter the email (if have emails)
